...
async function fetchDrivers() {
    try {
        ...
        showMessage('Error loading drivers data', 'error');
    }
}
...
function addDriverToTable(driver) {
    ...
    if (driver.dateOfBirth) {
        const birthDate = driver.dateOfBirth.toDate ? driver.dateOfBirth.toDate() : new Date(driver.dateOfBirth);
    ...
    tr.innerHTML = `
        <td>
            <div class="driver-img">
                <img src="${driver.imageURL || 'https://via.placeholder.com/40'}" alt="${driver.name}">
            </div>
        </td>
        <td>${driver.name}</td>
...
async function showEditDriverModal(driverId) {
    try {
        ...
        let dobValue = '';
        if (driver.dateOfBirth) {
            const date = driver.dateOfBirth.toDate ? driver.dateOfBirth.toDate() : new Date(driver.dateOfBirth);
        ...
        const modalContent = `
            <form id="edit-driver-form" data-id="${driver.id}">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="edit-driver-email" value="${driver.email || ''}" required>
                </div>
                
                <div class="form-group">
                    <label for="edit-driver-phone">Phone Number</label>
                    <input type="tel" id="edit-driver-phone" value="${driver.phoneNumber || ''}" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="edit-driver-bio" rows="3">${driver.bio || ''}</textarea>
                </div>
                
                <div class="form-group">
                    <label for="edit-driver-image">Profile Image URL</label>
                    <input type="url" id="edit-driver-image" value="${driver.imageURL || ''}">
                </div>
                
                <div class="form-group">
                    <label for="edit-driver-license-no">License Number</label>
                    <input type="text" id="edit-driver-license-no" value="${driver.licenseNo || ''}" required>
                </div>
                
                <div class="form-group">
                    <label for="edit-driver-license-url">License Document URL</label>
                    <input type="url" id="edit-driver-license-url" value="${driver.licenseURL || ''}">
                </div>
                
                <div class="form-group">
                    <label for="edit-driver-nationality-no">Nationality ID</label>
                    <input type="text" id="edit-driver-nationality-no" value="${driver.nationalityNo || ''}">
                </div>
                
                <div class="form-group">
                    <label for="edit-driver-nationality-url">Nationality Document URL</label>
                    <input type="url" id="edit-driver-nationality-url" value="${driver.nationalityURL || ''}">
                </div>
                
                <div class="form-group">
                    <label for="edit-driver-passport-no">Passport Number</label>
                    <input type="text" id="edit-driver-passport-no" value="${driver.passportNo || ''}">
                </div>
                
                <div class="form-group">
                    <label for="edit-driver-passport-url">Passport Document URL</label>
                    <input type="url" id="edit-driver-passport-url" value="${driver.passportURL || ''}">
                </div>
...
async function handleAddDriver(e) {
    ...
    if (!nameInput || !emailInput || !phoneInput || !genderInput || !dobInput || !licenseNoInput) {
...
async function handleEditDriver(e) {
    ...
    const nationalityNoInput = document.getElementById('edit-driver-nationality-no');
    const nationalityUrlInput = document.getElementById('edit-driver-nationality-url');
