...
async function fetchBuses() {
    try {
        ...
        showMessage('Error loading buses data', 'error');
    }
}
...
async function showEditBusModal(busId) {
    try {
        ...
        const modalContent = `
            <form id="edit-bus-form" data-id="${bus.id}" data-address-id="${bus.addressId || ''}">
                <div class="form-group">
                    <label for="edit-bus-number">Vehicle Number</label>
                    <input type="text" id="edit-bus-number" value="${bus.vehicleNo || ''}" placeholder="E.g., BUS-1234" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="edit-bus-type" required>
                        <option value="">Select Vehicle Type</option>
                        <option value="Bus" ${bus.vehicleType === 'Bus' ? 'selected' : ''}>Bus</option>
                        <option value="Shuttle" ${bus.vehicleType === 'Shuttle' ? 'selected' : ''}>Shuttle</option>
                        <option value="Minibus" ${bus.vehicleType === 'Minibus' ? 'selected' : ''}>Minibus</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="edit-bus-seats" value="${bus.countOfSeats || ''}" min="1" required>
                </div>
                ...
                <div class="address-details">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="edit-bus-street-name" value="${address.streetName || ''}">
                    </div>
                    
                    <div class="form-group">
                        <label for="edit-bus-street-number">Street Number</label>
                        <input type="text" id="edit-bus-street-number" value="${address.streetNumber || ''}">
                    </div>
                    
                    <div class="form-row">
                        <div class="form-group half">
                            <label for="edit-bus-city">City</label>
                            <input type="text" id="edit-bus-city" value="${address.city || ''}">
                        </div>
                        
                        <div class="form-group half">
                            <label for="edit-bus-district">District</label>
                            <input type="text" id="edit-bus-district" value="${address.district || ''}">
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <label for="edit-bus-country">Country</label>
                        <input type="text" id="edit-bus-country" value="${address.country || ''}">
                    </div>
                    
                    <div class="form-group">
                        <label for="edit-bus-next-to">Next To</label>
                        <input type="text" id="edit-bus-next-to" value="${address.nextTo || ''}" placeholder="Landmark or nearby location">
                    </div>
                </div>
